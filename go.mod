...
replace (
	...
	github.com/openshift/api => github.com/bparees/api v0.0.0-20191125163621-65f6fda
	github.com/openshift/client-go => github.com/bparees/client-go v0.0.0-20191125163924-dd349b0
